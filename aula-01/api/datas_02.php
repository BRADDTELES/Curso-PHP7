...
echo strftime($formatoData2, $agora->getTimestamp()), '<br>'; // usando só o 'pt_BR' Não traduziu para Português

$dataFixa = new DateTime('1975-01-25 15:30:50');
echo strftime($formatoDataHora, $dataFixa->getTimestamp()), '<br>'; // o getTimestamp leva em consideração a localidade da maquina atual

// $hora = new DateTime('-3 hour'); // <<< Diminuindo as Horas
// echo strftime($formatoDataHora, $hora->getTimestamp()), '<br>';
